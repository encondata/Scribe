...
source_location_options = ['Scanning Station', 'Loading Dock', '----------', 'Unpacking', 'Sorting']
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        combo.addItem(f"Bluetooth - {self.printer_bluetooth_mac}", "Bluetooth")
    ...
    def record_scan(self):
        ...
        if text.lower() == 'all':
            if os.path.isfile(CURRENT_FT_FILE):
                ...
                self.show_success_popup("All Labels Printed")
            else:
